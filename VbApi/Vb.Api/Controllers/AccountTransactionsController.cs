...
public class AccountTransactionsController : ControllerBase
{
   ...
   [HttpGet("filter")]
    public async Task<ApiResponse<List<AccountTransactionResponse>>> Filter([FromQuery] AccountTransactionByParameter request)
    {
        var operation = new GetAccountTransactionByParameterQuery(
